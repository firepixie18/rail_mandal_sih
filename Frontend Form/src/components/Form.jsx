        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="flex flex-col space-y-4">
            <LabelInputContainer>
              ...
              <Input id="mobilenumber" placeholder="Enter mobile number" type="tel" className="w-full border-gray-300 focus:border-black focus:ring-black" />
            </LabelInputContainer>
          ...
          <LabelInputContainer>
            ...
            <Input id="journeyDetails" placeholder="Enter journey details" type="text" className="border-gray-300 focus:border-black focus:ring-black" />
          </LabelInputContainer>

          <LabelInputContainer>
            <Label htmlFor="pnrnumber" className="text-sm font-medium text-gray-700">PNR Number*</Label>
            <Input id="pnrnumber" placeholder="Enter PNR number" type="text" className="border-gray-300 focus:border-black focus:ring-black" />
          </LabelInputContainer>
