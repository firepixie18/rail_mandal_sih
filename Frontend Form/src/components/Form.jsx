...
//     e.preventDefault();
//     console.log("Form submitted", { selectedType, incidentDate });
...
//   try {
//     const response = await axios.post('YOUR_BACKEND_ENDPOINT_2', formData2, {
//       headers: {
//         'Content-Type': 'application/json',
//       },
//     });
...
//             <Input id="mobilenumber" placeholder="Enter mobile number" type="tel" className="w-full border-gray-300 focus:border-black focus:ring-black" value={mobileNumber}
...
//           <Input id="journeyDetails" placeholder="Enter journey details" type="text" className="border-gray-300 focus:border-black focus:ring-black" value={journeyDetails}
...
//           <Input id="pnrnumber" placeholder="Enter PNR number" type="text" className="border-gray-300 focus:border-black focus:ring-black" value={pnrNumber}
